...
import BlogManAvatar from "../components/BlogManAvatar";
  ...
  return (
    <div>
     ...
     <   BlogAvatar id="blogPic"/>
      ...
      <img id="articleImage" alt="img" height={"450px"} width={"860px"} src= {selectedPost[0].imgSrc}/>
         <p id="articleParagraph">If you’re thinking of starting a blog of your own, but just don’t have a clue on what to blog about, then fear not!
